...
class Companion:
    ...
    def __init__(self, interface, save_result=False, print_debug=False):
        ...
        self.sessions_dir = f'{user_home}/.Aburihane/sessions/'
        self.pixiewps_dir = f'{user_home}/.Aburihane/pixiewps/'
...
def usage():
    return """
AburihanePin 0.0.2 (c) 2017 rofl0r, modded by drygdryg
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='AburihanePin 0.0.2 (c) 2017 rofl0r, modded by drygdryg',
